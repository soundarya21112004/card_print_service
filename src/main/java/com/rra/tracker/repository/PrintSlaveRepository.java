...
@Repository
public interface PrintSlaveRepository extends JpaRepository<SampleWs, Integer> {
...
//
    @Query(nativeQuery = true,
     ...
     ArrayList<String> loadListOfJsonData();
//
//    @Query(nativeQuery = true,
...
//
    @Query(nativeQuery = true,
            value = "select max(id) as max from sample_ws")
